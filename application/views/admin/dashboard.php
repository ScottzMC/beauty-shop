									...
									<ul class="chat-list-wrap">
										<li class="chat-list">
											<div class="chat-body">
												<a class="" href="#">
													<div class="chat-data">
														<img class="user-img img-circle" src="<?php echo base_url('uploads/original.jpg'); ?>"  alt="<?php echo $usrow->email; ?>"/>
														<div class="user-data">
															<span class="name block capitalize-font"><?php echo $usrow->email; ?></span>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
              ...
              ?>
                    ...
                    <li class="chat-list">
                            ...
                            <img class="user-img img-circle" src="<?php echo base_url('uploads/products/'.$image); ?>"  alt="<?php echo $prow->title; ?>"/>
														<div class="user-data">
                              <span class="name block capitalize-font">&#8358; <?php echo number_format($prow->price); ?></span>
