...
<head>
	...
	<title>View All Products || Admin Beauty Shop</title>
</head>
								...
								<div class="panel-body pa-0">
									<article class="col-item">
										<div class="photo">
											...
											<a href="#"> <img style="height: 300px; width: 230px;" src="<?php echo base_url('uploads/products/'.$image); ?>" class="img-responsive" alt="<?php echo $prow->title; ?>" /> </a>
										</div>
										<div class="info text-center">
											<h6><?php echo str_replace('-', ' ', $prow->title); ?></h6>
											<span class="product-spec capitalize-font block mt-5 mb-5"><?php echo $prow->category; ?></span>
