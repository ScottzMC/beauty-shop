...
<html lang="en">
    ...
    <?php foreach($edit_about_content as $edt_abt){} ?>
		<title>Edit <?php echo str_replace('-', ' ', $edt_abt->title); ?> About Content || Admin Beauty Shop</title>
	</head>
      ...
      <p class="text-muted">Add <code>About Contents of the website from here on the Footer.</code></p>
          ...
          <br><br>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea class="textarea_editor form-control" rows="15" name="body"><?php echo $edt_abt->body; ?></textarea><br>
