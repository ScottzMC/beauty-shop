...
<html lang="en">
	<head>
		...
		<title>Edit My Website About Page and Footer || Admin Beauty Shop</title>
	</head>
      ...
      <p class="text-muted">Add <code>About Contents of the website from here on the Footer.</code></p>
          ...
          <br><br>
				  ...
				  <div class="form-group">
						<textarea class="textarea_editor form-control" rows="15" name="body" placeholder="Enter text ..."></textarea>
