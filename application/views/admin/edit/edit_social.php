...
<html lang="en">
    ...
    <?php foreach($edit_social_link as $edt_soc){} ?>
		<title>Edit <?php echo str_replace('-', ' ', $edt_soc->social); ?> Social || Admin MCStitches</title>
	</head>
...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('admin/edit/content')?>">Edit Social Links</a></li>
...
<div class="panel panel-default card-view">
  <div class="panel-heading">
    ...
    <div class="panel-body">
      <form action="<?php echo base_url('admin/edit/content/edit_social_link/'.$edt_soc->id); ?>" method="post" role="form">
      <p class="text-muted">Edit <code>Social Links of the website from here on the Footer.</code></p>
          ...
          <input type="text" name="social" value="<?php echo $edt_soc->social; ?>"/><br>
          ...
          <br><br>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
              <input type="text" name="url" value="<?php echo $edt_soc->url; ?>"/><br>
						</div>
					 </div>
          <br>
  ...
  <?php
    if($this->form_validation->run() == TRUE){
      ...
      echo $this->session->flashdata('msgUpdatedSocialError');
    }
  ?>
