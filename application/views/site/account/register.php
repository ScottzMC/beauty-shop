...
<head>
    ...
    <title>Create an Account || Beauty Shop</title>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="contact-form">
                            ...
                            <form class="contact-form" action="<?php echo base_url('account/register'); ?>" method="post">
                            ...
                            ?>
                            <br>
                            Already registered? <a href="<?php echo site_url('account/login'); ?>">Login to Account</a>
                        </div>
                    </div>
                </div>
            </div>
